...
// counter app build using  react js 
...
function App() {
 ...
 function reset(){
  ...
  return (
    ...
    <div className="text-[#0398d4] font-medium text-2px">Increment && Decrement</div>
    <div className="bg-white flex justify-center gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
      <button onClick={decreaseHandler} className="border-r-2 text-center w-20 border-[#bfbfbf] text-5xl">
        -
      </button>
      <div className="border-r-2 text-center w-20 border-[#bfbfbf] text-5xl font-bold ">
